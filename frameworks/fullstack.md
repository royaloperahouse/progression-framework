---
path: "/developer/fullstack"
title: "🛠️ Fullstack Developer Framework"
sidebarTitle: "🛠️ Fullstack Dev"
sidebarGroup:
yaml: true
levels: 3
homepage: true
topics:
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Seeks guidance from other developers, rather than answers"
      - level: 2
        criteria:
      ...
      - level: 4
        criteria:
          ...
          - "Shares technical context and direction for less experienced developers"
          - "Gives direct and constructive feedback to other developers"
      - level: 5
        criteria:
  ...
  - name: "impact"
    ...
    content:
      ...
      - level: 6
        criteria:
          - "Accountable for delivery of large, mission critical developer projects"
          - "Originates or finishes large, horizontal developer efforts"
  - name: "leadership"
    title: "👩‍💼 Leadership"
    content:
      - level: 3
        criteria:
          - "Onboards / mentors new developers"
        exampleCriteria:
      ...
      - level: 4
        criteria:
          - "Contributes to maintaining the ROH culture in their team, helping new joiners"
          - "Gets buy-in on technical decision-making and proposed designs"
          - "Proactively involves other relevant developers"
          - "Sought out for code reviews"
          - "Instills ROH developer principles in other developers"
          - "Helps the growth of developers around them through coaching and mentoring"
      ...
      - level: 5
        criteria:
          - "Instills ROH developer principles across a whole squad of developers"
          - "Works with relevant developer Managers to help other developers perform and grow"
          ...
          - "Contributes to maintaining the ROH culture in the wider company"
    ...
    content:
      ...
      - level: 3
        criteria:
          ...
          - "Contributes to scaling developer hiring (e.g. leads calls, does onsite interviews)"
          - "Builds simple tools or iterates existing tools for the benefit of all developers"
      - level: 4
        criteria:
          - "Positively influences developers in the wider org"
          - "Maintains documentation on things they know the most, makes it easy for future developers to interact with systems/code"
          ...
          - "Drives changes to developer practices with well-reasoned arguments and a 'strong opinion, weakly held' mentality"
          - "Shapes the direction of systems designs with less experienced developers"
          - "Breaks down delivery and knowledge silos in their squad"
      - level: 5
        criteria:
          - "Represents ROH at conferences/events"
          - "Given as reason for other developers to join ROH"
  ...
  - name: "mastery"
    ...
    content:
      ...
      - level: 4
        criteria:
          - "Writes code that serves as a definitive example for new developers"
          ...
          - "Explains all aspects of the platform to new developers"
      ...
      - level: 5
        criteria:
          - "Builds systems that serve as definitive examples for new developers"
          ...
          - "Creates dashboards that broadly impact all developers"
        exampleCriteria:
      ...
      - level: 6
        criteria:
          ...
          - "Serves as a technical authority in the wider developer community"
---
### About our developer progression frameworks
The developer progression framework is a tool that helps developers and managers:
- make development and career plans
- talk about what we’re looking for from developers in a consistent way
...
### How does it work?
The framework covers all the things we’re looking for from developers at ROH. We’re interested in these five elements:
- Mastery - Your ROH knowledge and technical capability
- Impact - The size, scope and value of what you deliver
- Influence - How you change the world around you for the better
- Comms & Feedback - How you interact with others
- Leadership - How people around you become better and more impactful

We sort them into three levels, and we try to give specific examples of behaviours we expect for each.

None of this will happen mysteriously behind closed doors, your manager will work with you on this.  You’ll agree what level of progression you’re going for and what you need to improve on with your manager. It should be clear how you’re doing relative to that at all times.

### Things to keep in mind
- There are many different ways to progress and be valuable to ROH as you grow, including deep technical knowledge and ability, technical leadership and people management. All are equally valuable paths in ROH's developer team.
- The framework represents a career’s worth of progression, people shouldn’t expect to fly up it in 18 months!
- Developer progression isn’t an exact science and there will always be some ambiguity.
